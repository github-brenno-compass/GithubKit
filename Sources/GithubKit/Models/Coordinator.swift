...
/**
 ...
 The coordinator is responsible for handling all operations related to screen transitions and content presentation. The `NavigationKit` provides a range of options for presenting screens within a feature or in other features and mini apps.
